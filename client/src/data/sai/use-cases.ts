...
export const useCases: UseCase[] = [
  ...
  },
  {
    ...
    challenges: [
      'Team using multiple different CRMs—no visibility into team pipeline',
    ...
    results: [
      ...
      { metric: 'Software Consolidation', value: 'One platform' },
      { metric: 'Deals Closed (Team)', value: '+30% increase' },
    ],
  ...
  },
  {
    ...
    results: [
      ...
      { metric: 'Higher Commissions', value: 'Investment deals avg 2x residential' },
    ],
  ...
  },
  {
    ...
    saiSolution: [
      'All 50 agents on SAI Platform: $499/month (save $2,951/month = $35,412/year)',
    ...
    results: [
      { metric: 'Annual Software Savings', value: '$35,412' },
