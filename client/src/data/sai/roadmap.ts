...
export const roadmapFeatures: RoadmapFeature[] = [
  ...
  },
  {
    ...
    description: 'Google Veo 3 AI video generation for virtual property tours, automated narration, marketing videos, and virtual staging.',
    status: 'coming-soon',
    phase: 'Q4-2025',
    category: 'AI',
    benefits: [
  ...
  {
    id: 'ai-moe-team',
    title: 'AI MOE Team (Mixture of Experts)',
    description: '12 specialized AI expert agents (Listing Expert, Buyer\'s Agent, Investment Analyst, Luxury Market Expert, etc.) that collaborate on complex decisions.',
    status: 'future',
    phase: '2026',
    category: 'AI',
    benefits: [
      'Depth of expertise - 12 specialists vs. 1 generalist',
      'Better accuracy - experts catch nuances',
      'Diverse perspectives on complex decisions',
      'Confidence scoring for each expert\'s advice',
    ],
  },
  {
