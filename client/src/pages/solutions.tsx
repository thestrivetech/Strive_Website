            ...
            {mainSolutions.map((solution, index) => (
              <Link key={index} href={getMainSolutionUrl(solution.title)}>
                ...
                <CardContent className="p-0 relative z-10">
                  {/* Glow effect */}
                  <div className="absolute inset-1 bg-gradient-to-br from-primary/10 via-primary/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 -z-10 rounded-lg"></div>
