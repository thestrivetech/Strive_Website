...
const Home = () => {
  ...
  const industrySpecificSolutions = {
    healthcare: [
      { name: "AI-powered diagnostics and imaging analysis", icon: <Microscope className="w-8 h-8" />, painPoint: "Diagnostic errors affect 12 million Americans annually", description: "Reduce diagnostic errors by 85% with AI pattern recognition that analyzes medical imaging faster than human specialists", sourceUrl: "https://www.cbsnews.com/news/12-million-americans-misdiagnosed-each-year-study-says/" },
      { name: "Patient data management and EHR integration", icon: <ClipboardList className="w-8 h-8" />, painPoint: "Physicians spend 49% of time on EHR and desk work", description: "Save 3 hours per day with automated EHR management and intelligent data entry systems", sourceUrl: "https://www.aha.org/news/headline/2016-09-08-study-physicians-spend-nearly-twice-much-time-ehrdesk-work-patients" },
      { name: "Automated compliance and regulatory reporting", icon: <CheckCircle className="w-8 h-8" />, painPoint: "Over 31,000 HIPAA compliance investigations by OCR", description: "Achieve 99.9% HIPAA compliance with automated monitoring and real-time violation prevention", sourceUrl: "https://www.hipaajournal.com/what-are-the-penalties-for-hipaa-violations-7096/" },
      { name: "Predictive analytics for patient outcomes", icon: <TrendingUp className="w-8 h-8" />, painPoint: "14.67% average hospital readmission rates", description: "Reduce readmissions by 45% through AI-driven early intervention and risk prediction", sourceUrl: "https://www.definitivehc.com/resources/healthcare-insights/average-hospital-readmission-state" }
    ],
    finance: [
      { name: "Real-time fraud detection and prevention", icon: <Shield className="w-8 h-8" />, painPoint: "$10 billion in fraud losses in 2023", description: "Block 95% of fraudulent transactions in real-time with AI that learns from millions of transaction patterns", sourceUrl: "https://www.ftc.gov/news-events/news/press-releases/2024/02/nationwide-fraud-losses-top-10-billion-2023-ftc-steps-efforts-protect-public" },
      { name: "Automated risk assessment and reporting", icon: <TrendingUp className="w-8 h-8" />, painPoint: "72 hours for manual risk analysis", description: "Complete comprehensive risk assessments in under 5 minutes with 99% accuracy", sourceUrl: "https://www2.deloitte.com/us/en/insights/industry/financial-services/operational-risk-management.html" },
      { name: "Algorithmic trading and portfolio optimization", icon: <LineChart className="w-8 h-8" />, painPoint: "70% of US equity trading is algorithmic", description: "Execute trades at perfect timing with AI that processes market data 1000x faster than humans", sourceUrl: "https://www.sec.gov/news/studies/2010/marketstructure-studies.htm" },
      { name: "Customer behavior analytics and personalization", icon: <UserCheck className="w-8 h-8" />, painPoint: "75% expect personalized banking experiences", description: "Reduce churn by 60% with predictive analytics that anticipate customer needs before they arise", sourceUrl: "https://www.mckinsey.com/industries/financial-services/our-insights/personalization-in-banking" }
    ],
    manufacturing: [
      { name: "Predictive maintenance and equipment monitoring", icon: <Wrench className="w-8 h-8" />, painPoint: "$50K/hour in unplanned downtime costs", description: "Reduce equipment failures by 75% with AI that predicts breakdowns 48 hours in advance", sourceUrl: "https://www.plantengineering.com/articles/unplanned-downtime-costs-manufacturers-50k-per-hour/" },
      { name: "Quality control automation with computer vision", icon: <Eye className="w-8 h-8" />, painPoint: "23% of unplanned downtime from human error", description: "Achieve 99.9% quality standards with computer vision that catches defects humans miss", sourceUrl: "https://www.asq.org/quality-resources/articles/cost-of-quality" },
      { name: "Supply chain optimization and demand forecasting", icon: <Package className="w-8 h-8" />, painPoint: "30% excess inventory costs", description: "Cut inventory costs by 40% with AI demand forecasting accurate to within 2%", sourceUrl: "https://www.mckinsey.com/capabilities/operations/our-insights/supply-chain-excellence-in-the-digital-age" },
      { name: "Production workflow automation", icon: <Settings className="w-8 h-8" />, painPoint: "Only 12% of manufacturers fully automated", description: "Increase throughput by 35% with intelligent workflow optimization and automation", sourceUrl: "https://www.manufacturing.net/operations/article/13248995/study-finds-manufacturers-are-slow-to-adopt-automation" }
    ],
    retail: [
      { name: "Customer analytics and personalized recommendations", icon: <Target className="w-8 h-8" />, painPoint: "91% of consumers shop with personalized brands", description: "Triple conversion rates with AI personalization that shows each customer exactly what they want", sourceUrl: "https://www.epsilon.com/us/about-us/pressroom/new-epsilon-research-indicates-80-of-consumers-are-more-likely-to-make-a-purchase-when-brands-offer-personalized-experiences" },
      { name: "Inventory management and demand prediction", icon: <BarChart className="w-8 h-8" />, painPoint: "$1.75 trillion tied up in inventory globally", description: "Eliminate stockouts with AI that predicts demand spikes 2 weeks in advance", sourceUrl: "https://www.mckinsey.com/industries/retail/our-insights/inventory-management-the-key-to-retail-success" },
      { name: "Dynamic pricing optimization", icon: <Coins className="w-8 h-8" />, painPoint: "Losing 15% margin to price competition", description: "Maximize profits with real-time pricing that adjusts to market conditions instantly", sourceUrl: "https://www.mckinsey.com/industries/retail/our-insights/getting-pricing-right" },
      { name: "Omnichannel customer experience automation", icon: <Globe className="w-8 h-8" />, painPoint: "73% of consumers use multiple channels", description: "Reduce abandonment by 50% with seamless cross-channel experience and smart retargeting", sourceUrl: "https://www.salesforce.com/resources/articles/customer-experience/" }
    ],
    technology: [
      { name: "DevOps automation and CI/CD optimization", icon: <Zap className="w-8 h-8" />, painPoint: "200x more frequent deployments with DevOps", description: "Deploy 10x faster with zero-downtime CI/CD that eliminates 90% of deployment failures", sourceUrl: "https://www.atlassian.com/devops/what-is-devops/benefits-of-devops" },
      { name: "AI agent development and deployment", icon: <Brain className="w-8 h-8" />, painPoint: "75% of companies plan AI agents by 2025", description: "Save 80% on operational costs with AI agents that automate complex workflows 24/7", sourceUrl: "https://www.ibm.com/blogs/watson/2024/02/ai-agents-business-transformation/" },
      { name: "Cloud infrastructure and scaling solutions", icon: <Globe className="w-8 h-8" />, painPoint: "30% of cloud spend is wasted", description: "Cut cloud costs by 50% with intelligent auto-scaling that matches demand perfectly", sourceUrl: "https://www.computerweekly.com/news/365528434/Cloud-waste-costs-organizations-billions" },
      { name: "Data pipeline automation and analytics", icon: <TrendingUp className="w-8 h-8" />, painPoint: "80% of analyst time on data preparation", description: "Get real-time insights with automated pipelines that process terabytes in minutes", sourceUrl: "https://venturebeat.com/data-infrastructure/80-of-data-scientists-time-is-spent-on-data-preparation/" }
    ],
    education: [
      { name: "Learning analytics and student performance insights", icon: <BookOpen className="w-8 h-8" />, painPoint: "Only 60% of students graduate in 6 years", description: "Identify at-risk students 85% earlier with AI that analyzes learning patterns in real-time", sourceUrl: "https://www.usnews.com/education/best-colleges/articles/see-graduation-rates-by-college" },
      { name: "Administrative workflow automation", icon: <Clipboard className="w-8 h-8" />, painPoint: "60% time on paperwork vs teaching", description: "Free up 5 hours daily for teaching by automating administrative tasks completely", sourceUrl: "https://www.edweek.org/leadership/teachers-spend-nearly-3-hours-a-day-on-paperwork-survey-finds/2019/06" },
      { name: "Personalized learning path recommendations", icon: <Target className="w-8 h-8" />, painPoint: "93% of students want personalized learning", description: "Improve outcomes by 70% with AI that creates unique learning paths for each student", sourceUrl: "https://www.edtechmagazine.com/higher/article/2023/05/how-personalized-learning-transforms-student-outcomes" },
      { name: "Automated grading and assessment tools", icon: <PenTool className="w-8 h-8" />, painPoint: "Teachers work 54 hours per week average", description: "Provide instant feedback with AI grading that's 95% accurate and available 24/7", sourceUrl: "https://www.rand.org/pubs/research_reports/RR1327.html" }
    ],
    "real-estate": [
      { name: "Property valuation and market analysis", icon: <Building2 className="w-8 h-8" />, painPoint: "Home appraisals off by 20% or more", description: "Achieve 98% valuation accuracy with AI analyzing 500+ market factors instantly", sourceUrl: "https://www.realtor.com/news/trends/how-accurate-are-home-price-estimates/" },
      { name: "Automated property management workflows", icon: <FileText className="w-8 h-8" />, painPoint: "5% average US vacancy rate costs billions", description: "Fill properties 60% faster with automated screening and instant lease processing", sourceUrl: "https://www.apartments.com/rental-manager/resources/article/rental-vacancy-rates/" },
      { name: "Lead generation and customer relationship management", icon: <Users className="w-8 h-8" />, painPoint: "Only 3% of leads convert to sales", description: "Triple conversion rates with AI that nurtures leads and identifies hot prospects automatically", sourceUrl: "https://blog.marketo.com/2018/04/b2b-lead-conversion-benchmark-report-2018.html" },
      { name: "Market trend prediction and investment insights", icon: <TrendingUp className="w-8 h-8" />, painPoint: "63% of investors miss profitable opportunities", description: "Spot profitable opportunities 30 days earlier with predictive market analytics", sourceUrl: "https://www.pwc.com/us/en/industries/asset-wealth-management/real-estate/emerging-trends-real-estate-2024.html" }
    ],
    legal: [
      { name: "Document automation and contract analysis", icon: <FileText className="w-8 h-8" />, painPoint: "Lawyers spend 48% of time on admin tasks", description: "Review contracts in 30 minutes with AI that catches risks humans miss 40% of the time", sourceUrl: "https://www.americanbar.org/news/abanews/publications/youraba/2023/january-2023/legal-practice-technology-continues-to-evolve/" },
      { name: "Case management and workflow optimization", icon: <Scale className="w-8 h-8" />, painPoint: "23% of malpractice claims from admin errors", description: "Never miss a deadline with automated workflows that track every case milestone", sourceUrl: "https://www.americanbar.org/news/abanews/aba-news-archives/2019/03/new-report-shows-/ " },
      { name: "Legal research and precedent discovery", icon: <Search className="w-8 h-8" />, painPoint: "20 hours average per case on research", description: "Find relevant precedents in seconds with AI that searches millions of cases instantly", sourceUrl: "https://www.americanbar.org/news/abanews/aba-news-archives/2023/06/legal-research-technology-transforms-practice/" },
      { name: "Compliance monitoring and risk assessment", icon: <ShieldAlert className="w-8 h-8" />, painPoint: "$4.7B in legal regulatory fines in 2023", description: "Maintain 100% compliance with real-time monitoring that prevents violations before they occur", sourceUrl: "https://www.complianceweek.com/regulatory-enforcement/regulatory-fines-and-penalties-continue-to-climb/33362.article" }
    ]
  };
