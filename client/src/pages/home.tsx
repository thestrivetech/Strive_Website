...
import { CheckCircle2, ArrowRight, TrendingUp, Target, Users, ChevronDown, Sparkles, Zap, Clock } from "lucide-react";
            ...
            <div className="max-w-5xl mx-auto">
              ...
              <div className="text-center mb-12 sm:mb-16">
                <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold leading-tight text-white mb-6 sm:mb-8">
                  <span className="text-[#ff7033]">SAI</span> - Your AI Powered Real Estate Platform
                </h1>
              </div>
              ...
              <div className="text-center space-y-6 sm:space-y-8">
                <p className="text-xl sm:text-2xl md:text-3xl text-white/95 leading-relaxed max-w-4xl mx-auto">
                ...
                <div className="pt-4">
                  <Button
                    ...
                    className="bg-primary hover:bg-primary/90 text-primary-foreground px-10 sm:px-12 lg:px-16 py-5 sm:py-6 lg:py-7 text-lg sm:text-xl lg:text-2xl min-h-[56px] shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
                    size="lg"
                  >
                    Get Started
                  </Button>
