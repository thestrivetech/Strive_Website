...
const Home = () => {
  ...
  const industrySpecificSolutions = {
    healthcare: [
      { name: "AI-powered diagnostics and imaging analysis", icon: <Microscope className="w-8 h-8" />, painPoint: "70% misdiagnosis rate in complex cases", description: "Reduce diagnostic errors by 85% with AI pattern recognition that analyzes medical imaging faster than human specialists", sourceUrl: "https://www.mckinsey.com/industries/healthcare/our-insights/transforming-healthcare-with-ai" },
      { name: "Patient data management and EHR integration", icon: <ClipboardList className="w-8 h-8" />, painPoint: "4+ hours daily on documentation", description: "Save 3 hours per day with automated EHR management and intelligent data entry systems", sourceUrl: "https://www.healthit.gov/buzz-blog/health-it/time-motion-studies-ehr-documentation-burden" },
      { name: "Automated compliance and regulatory reporting", icon: <CheckCircle className="w-8 h-8" />, painPoint: "$2.5M average HIPAA violation penalty", description: "Achieve 99.9% HIPAA compliance with automated monitoring and real-time violation prevention", sourceUrl: "https://www.hhs.gov/hipaa/for-professionals/compliance-enforcement/agreements/index.html" },
      { name: "Predictive analytics for patient outcomes", icon: <TrendingUp className="w-8 h-8" />, painPoint: "30% hospital readmission rates", description: "Reduce readmissions by 45% through AI-driven early intervention and risk prediction", sourceUrl: "https://www.cms.gov/medicare/quality-initiatives-patient-assessment-instruments/hospitalqualityinits/hospitalreadmissions" }
    ],
    finance: [
      { name: "Real-time fraud detection and prevention", icon: <Shield className="w-8 h-8" />, painPoint: "$5.8 billion lost to fraud annually", description: "Block 95% of fraudulent transactions in real-time with AI that learns from millions of transaction patterns", sourceUrl: "https://www.federalreserve.gov/publications/files/payments-fraud-losses-report-2019.pdf" },
      { name: "Automated risk assessment and reporting", icon: <TrendingUp className="w-8 h-8" />, painPoint: "72 hours for manual risk analysis", description: "Complete comprehensive risk assessments in under 5 minutes with 99% accuracy", sourceUrl: "https://www.mckinsey.com/industries/financial-services/our-insights/ai-bank-of-the-future-can-banks-meet-the-ai-challenge" },
      { name: "Algorithmic trading and portfolio optimization", icon: <LineChart className="w-8 h-8" />, painPoint: "60% of trades miss optimal timing", description: "Execute trades at perfect timing with AI that processes market data 1000x faster than humans", sourceUrl: "https://www.jpmorgan.com/insights/research/machine-learning-investments" },
      { name: "Customer behavior analytics and personalization", icon: <UserCheck className="w-8 h-8" />, painPoint: "85% customer churn due to poor service", description: "Reduce churn by 60% with predictive analytics that anticipate customer needs before they arise", sourceUrl: "https://www.accenture.com/us-en/insights/banking/future-banking-ecosystem" }
    ],
    manufacturing: [
      { name: "Predictive maintenance and equipment monitoring", icon: <Wrench className="w-8 h-8" />, painPoint: "$50K/hour in unplanned downtime costs", description: "Reduce equipment failures by 75% with AI that predicts breakdowns 48 hours in advance", sourceUrl: "https://www.mckinsey.com/business-functions/mckinsey-digital/our-insights/the-age-of-analytics-competing-in-a-data-driven-world" },
      { name: "Quality control automation with computer vision", icon: <Eye className="w-8 h-8" />, painPoint: "3-5% defect rates in production", description: "Achieve 99.9% quality standards with computer vision that catches defects humans miss", sourceUrl: "https://www.bcg.com/publications/2018/man-machine-in-manufacturing-artificial-intelligence" },
      { name: "Supply chain optimization and demand forecasting", icon: <Package className="w-8 h-8" />, painPoint: "30% excess inventory costs", description: "Cut inventory costs by 40% with AI demand forecasting accurate to within 2%", sourceUrl: "https://www.pwc.com/us/en/industries/industrial-products/library/supply-chain-digital-transformation.html" },
      { name: "Production workflow automation", icon: <Settings className="w-8 h-8" />, painPoint: "45% production capacity underutilized", description: "Increase throughput by 35% with intelligent workflow optimization and automation", sourceUrl: "https://www.deloitte.com/global/en/insights/industry/manufacturing/manufacturing-digital-transformation.html" }
    ],
    retail: [
      { name: "Customer analytics and personalized recommendations", icon: <Target className="w-8 h-8" />, painPoint: "Only 2% conversion rate average", description: "Triple conversion rates with AI personalization that shows each customer exactly what they want", sourceUrl: "https://www.mckinsey.com/industries/retail/our-insights/personalizing-the-customer-experience-driving-differentiation-in-retail" },
      { name: "Inventory management and demand prediction", icon: <BarChart className="w-8 h-8" />, painPoint: "20% stockout rate during peak times", description: "Eliminate stockouts with AI that predicts demand spikes 2 weeks in advance", sourceUrl: "https://www.nrf.com/research/retail-digital-supply-chain-transformation" },
      { name: "Dynamic pricing optimization", icon: <Coins className="w-8 h-8" />, painPoint: "Losing 15% margin to price competition", description: "Maximize profits with real-time pricing that adjusts to market conditions instantly", sourceUrl: "https://www.bcg.com/publications/2017/retail-technology-digital-price-optimization-retail" },
      { name: "Omnichannel customer experience automation", icon: <Globe className="w-8 h-8" />, painPoint: "67% cart abandonment rate", description: "Reduce abandonment by 50% with seamless cross-channel experience and smart retargeting", sourceUrl: "https://www.salesforce.com/resources/articles/customer-experience/" }
    ],
    technology: [
      { name: "DevOps automation and CI/CD optimization", icon: <Zap className="w-8 h-8" />, painPoint: "40% developer time on deployment issues", description: "Deploy 10x faster with zero-downtime CI/CD that eliminates 90% of deployment failures", sourceUrl: "https://www.puppet.com/resources/report/2021-state-of-devops-report/" },
      { name: "AI agent development and deployment", icon: <Brain className="w-8 h-8" />, painPoint: "$200K+ annual cost for repetitive tasks", description: "Save 80% on operational costs with AI agents that automate complex workflows 24/7", sourceUrl: "https://www.mckinsey.com/capabilities/mckinsey-digital/our-insights/the-economic-potential-of-generative-ai-the-next-productivity-frontier" },
      { name: "Cloud infrastructure and scaling solutions", icon: <Globe className="w-8 h-8" />, painPoint: "70% cloud resources underutilized", description: "Cut cloud costs by 50% with intelligent auto-scaling that matches demand perfectly", sourceUrl: "https://aws.amazon.com/economics/" },
      { name: "Data pipeline automation and analytics", icon: <TrendingUp className="w-8 h-8" />, painPoint: "5 days to generate business reports", description: "Get real-time insights with automated pipelines that process terabytes in minutes", sourceUrl: "https://www.databricks.com/resources/ebook/big-book-of-mlops" }
    ],
    education: [
      { name: "Learning analytics and student performance insights", icon: <BookOpen className="w-8 h-8" />, painPoint: "40% student dropout rate", description: "Identify at-risk students 85% earlier with AI that analyzes learning patterns in real-time", sourceUrl: "https://nces.ed.gov/programs/raceindicators/indicator_rfa.asp" },
      { name: "Administrative workflow automation", icon: <Clipboard className="w-8 h-8" />, painPoint: "60% time on paperwork vs teaching", description: "Free up 5 hours daily for teaching by automating administrative tasks completely", sourceUrl: "https://www.edweek.org/teaching-learning/teachers-spend-nearly-as-much-time-on-paperwork-as-instruction-survey-finds/2019/10" },
      { name: "Personalized learning path recommendations", icon: <Target className="w-8 h-8" />, painPoint: "One-size-fits-all curriculum fails 50%", description: "Improve outcomes by 70% with AI that creates unique learning paths for each student", sourceUrl: "https://www.rand.org/pubs/research_reports/RR2042.html" },
      { name: "Automated grading and assessment tools", icon: <PenTool className="w-8 h-8" />, painPoint: "2 weeks average grading turnaround", description: "Provide instant feedback with AI grading that's 95% accurate and available 24/7", sourceUrl: "https://www.ets.org/research/policy_research_reports/publications/report/2019/jwbg.html" }
    ],
    "real-estate": [
      { name: "Property valuation and market analysis", icon: <Building2 className="w-8 h-8" />, painPoint: "15% valuation errors cost millions", description: "Achieve 98% valuation accuracy with AI analyzing 500+ market factors instantly", sourceUrl: "https://www.nar.realtor/research-and-statistics/research-reports/profile-of-home-buyers-and-sellers" },
      { name: "Automated property management workflows", icon: <FileText className="w-8 h-8" />, painPoint: "30% vacancy rates from slow processing", description: "Fill properties 60% faster with automated screening and instant lease processing", sourceUrl: "https://www.nmhc.org/research-insight/research-report/nmhc-rent-payment-study/" },
      { name: "Lead generation and customer relationship management", icon: <Users className="w-8 h-8" />, painPoint: "80% of leads never convert", description: "Triple conversion rates with AI that nurtures leads and identifies hot prospects automatically", sourceUrl: "https://www.inman.com/2019/10/01/study-agent-conversion-rates-show-huge-opportunity-for-improvement/" },
      { name: "Market trend prediction and investment insights", icon: <TrendingUp className="w-8 h-8" />, painPoint: "Missing 40% of investment opportunities", description: "Spot profitable opportunities 30 days earlier with predictive market analytics", sourceUrl: "https://www.pwc.com/us/en/industries/financial-services/fintech/bitcoin-blockchain-cryptocurrency.html" }
    ],
    legal: [
      { name: "Document automation and contract analysis", icon: <FileText className="w-8 h-8" />, painPoint: "20 hours per contract review", description: "Review contracts in 30 minutes with AI that catches risks humans miss 40% of the time", sourceUrl: "https://www.americanbar.org/groups/law_practice/publications/techreport/abatechreport2019/" },
      { name: "Case management and workflow optimization", icon: <Scale className="w-8 h-8" />, painPoint: "35% cases miss critical deadlines", description: "Never miss a deadline with automated workflows that track every case milestone", sourceUrl: "https://www.thomsonreuters.com/en-us/posts/legal/legal-departments-2020-state-industry/" },
      { name: "Legal research and precedent discovery", icon: <Search className="w-8 h-8" />, painPoint: "50+ hours on case research", description: "Find relevant precedents in seconds with AI that searches millions of cases instantly", sourceUrl: "https://www.westlaw.com/content/westlaw/pdf/state-of-legal-research.pdf" },
      { name: "Compliance monitoring and risk assessment", icon: <ShieldAlert className="w-8 h-8" />, painPoint: "$4M average compliance violation fine", description: "Maintain 100% compliance with real-time monitoring that prevents violations before they occur", sourceUrl: "https://www.americanbar.org/groups/professional_responsibility/publications/model_rules_professional_conduct/" }
    ]
  };
