...
- Change badges on the home page in the "specific industry solutions" section to where the Icons turn a different color when the user clicks on them instead of staying orange which currently blends together.
- 
